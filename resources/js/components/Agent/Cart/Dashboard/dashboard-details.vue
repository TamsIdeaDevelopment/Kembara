                                    ...
                                    <form class="form" id="kt_form" @submit.prevent="checkValidation"  enctype="multipart/form-data">
                                        ...
                                        <div class="d-flex justify-content-between border-top mt-3 pt-3">
                                            ...
                                            <div>
                                                ...
                                                <button type="submit" v-if="this.delivery_type == 0 && this.total_delivery_fee == 0 && this.seller_id > 1" class="btn btn-success font-weight-bolder text-uppercase px-9 py-4" data-wizard-state="action-submit" data-wizard-type="action-submit">Order</button>
                                                <button type="button" @click="checkDelivery()" v-if="this.delivery_type == 0 && this.total_delivery_fee == 0 && this.seller_id == 1" class="btn btn-success font-weight-bolder text-uppercase px-9 py-4" data-wizard-state="action-submit" data-wizard-type="action-submit">Order</button>
            ...
            checkValidation(){
                ...
                if(this.delivery_type == 0)
                {
                    ...
                    if(!this.DeliveryDetails.name || !this.DeliveryDetails.phone_no || !this.DeliveryDetails.address_1 || !this.DeliveryDetails.postcode || !this.DeliveryDetails.city || !this.DeliveryDetails.state || !this.DeliveryDetails.country || !this.DeliveryDetails.country)
                    {
                        ...
                        toastr.error("Please complete the details", "Failed");
                    }
                }
