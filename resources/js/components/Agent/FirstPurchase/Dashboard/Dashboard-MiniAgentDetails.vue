                            ...
                            <div class="row justify-content-center">
                                <div class="col-xl-12 col-xxl-12">
                                    ...
                                    <form class="form" id="kt_form" @submit.prevent="checkValidation"  enctype="multipart/form-data">
                                        <mini-agent-first-purchase-elements :data="IsSellerHQ"></mini-agent-first-purchase-elements>
                                        <mini-agent-first-purchase-delivery-address-elements></mini-agent-first-purchase-delivery-address-elements>
                                        <mini-agent-first-purchase-payment-method-elements></mini-agent-first-purchase-payment-method-elements>
                                        <mini-agent-first-purchase-review-submit-elements></mini-agent-first-purchase-review-submit-elements>
...
//                })
            ...
            checkDelivery() {
                Swal.fire({
                    ...
                    html: 'You need to <strong><u>hard refresh</u></strong> your browser then, click <strong>Buy Now</strong> to continue.',
                    icon: 'warning',
