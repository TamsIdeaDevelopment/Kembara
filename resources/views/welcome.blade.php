...
<head>
    ...
    <!--title-->
    <title>KEMBARA Meals</title>

    <!--favicon icon-->
    <link rel="icon" href="assets2/image/kembara-logo2.png" type="image/png" sizes="10x10">
    ...
    <nav class="navbar navbar-expand-lg fixed-top bg-transparent">
        <div class="container">
            <a class="navbar-brand" href="{{ route('/') }}">
                ...
                {{--<img src="assets2/assets/img/kembara-logo-depan.png" alt="logo" class="img-fluid" style="width:100px; height: 50px;" />--}}
            </a>
            <a href="{{ route('login') }}">
